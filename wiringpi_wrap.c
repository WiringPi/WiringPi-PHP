...
#define SWIG_ErrorMsg() ZEND_MODULE_GLOBALS_ACCESSOR(wiringpi, error_msg)
#define SWIG_ErrorCode() ZEND_MODULE_GLOBALS_ACCESSOR(wiringpi, error_code)
#ifdef __GNUC__
...
static zend_function_entry wiringpi_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(digitalreadbyte,_wrap_digitalReadByte,swig_arginfo_)
 ...
 SWIG_ZEND_NAMED_FE(ads1115setup,_wrap_ads1115Setup,swig_arginfo_00)
 ...
 SWIG_ZEND_NAMED_FE(softservowrite,_wrap_softServoWrite,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(softservosetup,_wrap_softServoSetup,swig_arginfo_00000000)
 ...
 SWIG_ZEND_NAMED_FE(scrollphatpoint,_wrap_scrollPhatPoint,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(scrollphatline,_wrap_scrollPhatLine,swig_arginfo_00000)
 SWIG_ZEND_NAMED_FE(scrollphatlineto,_wrap_scrollPhatLineTo,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(scrollphatrectangle,_wrap_scrollPhatRectangle,swig_arginfo_000000)
 SWIG_ZEND_NAMED_FE(scrollphatupdate,_wrap_scrollPhatUpdate,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(scrollphatclear,_wrap_scrollPhatClear,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(scrollphatputchar,_wrap_scrollPhatPutchar,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(scrollphatputs,_wrap_scrollPhatPuts,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(scrollphatprintf,_wrap_scrollPhatPrintf,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(scrollphatprintspeed,_wrap_scrollPhatPrintSpeed,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(scrollphatintensity,_wrap_scrollPhatIntensity,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(scrollphatsetup,_wrap_scrollPhatSetup,swig_arginfo_)
